...
from EC.nets.ssd_layers import Detect, L2Norm, PriorBox
from EC.nets.vgg import vgg as add_vgg
import matplotlib.pyplot as plt
import cv2
from tools.Net_Vision import Cnn_View,draw_cam
class SSD(nn.Module):
    def __init__(self, phase, base, extras, head, num_classes, confidence, nms_iou):
        ...
        self.cfg_student = Config
        self.vgg = nn.ModuleList(base)
        self.L2Norm = L2Norm(512, 20)
        self.extras = nn.ModuleList(extras)
        self.priorbox = PriorBox(self.cfg_student)
        with torch.no_grad():
    ...
    def forward(self, x):
        ...
        #   shape为19,19,1024
        # ---------------------------#
        # for k in range(19, len(self.vgg)):
        ...
        for i in range(9):
            plt.subplot(3, 3, i + 1)
            plt.imshow(See[0, i, :, :], cmap='viridis')  # i是通道
            plt.savefig('E:/graduate/student/img/feature_img-{}.jpg'.format(i))
        ...
        # test时候output.shape = [batch_size,num_class,top_k,5]
